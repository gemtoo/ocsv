...
ip6tables -t nat -A POSTROUTING -o eth0 -s fd0e:1ced:c0ff:ee::/48 -j MASQUERADE && ip6tables -A FORWARD -i ocserv0 -o eth0 -j ACCEPT && ip6tables -A FORWARD -i eth0 -o ocserv0 -j ACCEPT
